...
* [**Espressif**][Espressif] has very generously sponsored ESP32-P4 chips, ESP32-C6 modules as well as the flash chips to store the firmware. The ESP32 has proven itself to be a solid basis for badges in the past. Espressif's continued support means a lot to us as it allows us to continue expanding our existing ESP32-based ecosystem!
...
Jhaand (Jelle Haandrikma) - Testing and more

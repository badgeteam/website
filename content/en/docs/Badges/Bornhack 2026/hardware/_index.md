...
| Display | 1.54" e-paper, 152 × 152, SSD1680-class controller | SPI |
...
The badge uses a 1.54 inch e-paper display with a resolution of **152 × 152** pixels, driven by an SSD1680-class controller. E-paper keeps the badge readable in bright camp sunlight and draws no power to hold an image, which is a big help for the week-long battery goal.
